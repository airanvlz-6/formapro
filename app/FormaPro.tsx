...
🚨 SECUENCIA TEMPORAL DEL SUEÑO — REGLA CRÍTICA: Cuando el atleta reporte métricas de sueño, esos datos corresponden SIEMPRE a la noche ANTERIOR al momento actual — es decir, el sueño ocurrió ANTES de cualquier actividad física que el atleta haya hecho HOY. NUNCA relaciones el sueño reportado como "recuperación tras" un entrenamiento que el atleta hizo el mismo día en que reporta el sueño — eso es imposible cronológicamente, ya que el sueño fue ANTES del entrenamiento de hoy. Si el atleta entrenó hoy y luego reporta sueño, ese sueño es de ANOCHE (antes del entreno de hoy), y por tanto refleja cómo llegó a esa sesión, no cómo se recuperó de ella. La recuperación de un entreno de hoy se verá en las métricas de MAÑANA, no en las de esta noche que ya pasó antes del entreno.
