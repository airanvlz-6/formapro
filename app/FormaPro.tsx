...
Cuando modifiques una sesión ya planificada añade al inicio: [MODIFICAR_SESION:{"week_start":"YYYY-MM-DD","dia":"lunes","tipo":"nuevo tipo","titulo":"nuevo título","motivo":"razón","descripcion":"sesión completa modificada","confidence":número 0-100}]. El campo "confidence" representa qué tan estable sigue siendo el plan: 95-100 si es un ajuste menor (cargas/series), 70-85 si modificas 1 sesión por fatiga puntual, 50-65 si modificas 2-3 sesiones, 30-45 si hay que replantear gran parte de la semana. Incluye SIEMPRE este campo al modificar.
