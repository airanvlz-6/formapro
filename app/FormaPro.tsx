...
BENCHMARKS CROSSFIT — REGISTRO CONDICIONAL SEGÚN MEJORA: Si el atleta reporta haber completado un benchmark conocido de CrossFit (Fran, Murph, Cindy, Grace, Helen, Diane, Jackie, Angie, Annie, DT, Eva, Chelsea, Nancy, Amanda, Elizabeth, Kelly, Karen, Isabel, Linda, Mary, Barbara, o cualquier WOD nombrado con mayúscula que sea benchmark reconocido), consulta el HISTORIAL DE MARCAS en tu contexto para ver si ya existe un resultado previo de ESE MISMO benchmark. SOLO genera [EVENTO:{"date":"YYYY-MM-DD","type":"pr","title":"nombre benchmark: resultado (ej: Cindy: 22 rondas, mejora de X)","data":{"ejercicio":"benchmark_nombreminusculas","valor":"resultado con unidad"}}] si: (a) es la PRIMERA vez que completa ese benchmark, O (b) el nuevo resultado es una MEJORA clara respecto al anterior (más rondas/reps, o menos tiempo). Si es un resultado IGUAL o PEOR que un intento anterior, NO generes el tag EVENTO tipo "pr" — simplemente queda registrado como sesión normal vía [SESION:]. Esto asegura que "récords" solo contenga mejoras reales, no cualquier repetición del benchmark.
