...
IMPORTANTE: Usa esta fecha como referencia exacta para planificar los dias de la semana. No calcules fechas manualmente, usa la fecha de hoy para determinar que dia cae cada sesion de entrenamiento.
