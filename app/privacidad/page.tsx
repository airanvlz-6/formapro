export default function Privacidad() {
  return (
    <div style={{maxWidth:720,margin:"0 auto",padding:"60px 24px",fontFamily:"'DM Sans',sans-serif",color:"#1A1A1A",lineHeight:1.75}}>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>1. Responsable del tratamiento</h2>
      <p style={{marginBottom:24}}>Airán Velázquez — Forge (forgeapp.es) — coachforgeapp@gmail.com</p>

      <h2 style={{fontSize:20,marginBottom:8}}>2. Datos que recogemos</h2>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>3. Finalidad del tratamiento</h2>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>4. Base legal</h2>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>5. Conservación de datos</h2>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>6. Derechos del usuario</h2>
      ...
      <h2 style={{fontSize:20,marginBottom:8}}>7. Proveedores técnicos</h2>
      ...
      <a href="/" style={{color:"#1E5C3A",fontSize:14}}>← Volver a Forge</a>
    </div>
  );
}