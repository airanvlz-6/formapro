    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif", padding: "24px 16px" }}>
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",gap:10,marginTop:24,paddingTop:20,borderTop:`1px solid ${C.border}`}}>
          <a href={`/historia?codigo=${codigo}`} style={{color:C.muted,fontSize:13,textDecoration:"none",display:"flex",alignItems:"center",gap:4}}>← Mi Historia</a>
          <a href={`/atleta?codigo=${codigo}`} style={{color:C.accent,fontSize:13,textDecoration:"none",fontWeight:600,display:"flex",alignItems:"center",gap:4}}>Mi Atleta →</a>
        </div>
