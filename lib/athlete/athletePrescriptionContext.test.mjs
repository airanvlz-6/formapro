...
function database({ fail, user = hybrid } = {}) {
  ...
  const tables = { usuarios: user, weekly_plan: [{ week_start: '2026-08-31', sessions: [{ dia: 'martes', tipo: 'box',
    ...
    session_modification_events: [], athlete_state_events: [], athlete_coaching_notes: [], physiology_records: [] };
...
for (const table of ['usuarios', 'weekly_plan', 'session_modification_events', 'athlete_state_events', 'athlete_coaching_notes', 'physiology_records'])
