...
function executeBranch(action, extra) {
  ...
  const context = { ...authority, ...adapters, ...load('lib/auth/legacyContainment.ts'), ...load('lib/chat/conversationEvidence.ts'), ...extra, NextResponse: { json: (body, options) => ({ body, options }) } };
