...
import { sportsRuntime, contractFixture, plain, fakeDatabase, completeDoseFixture } from '../sports/trainingContractTestRuntime.mjs';
...
function strategyDatabase() {
  const tables = { usuarios: { modo_entrada: 'coach', categoria: 'carrera', especialidad: 'crossfit', perfil: { dias: 5 },
