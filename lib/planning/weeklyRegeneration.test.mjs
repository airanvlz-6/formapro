...
function proposal(c,options){return {contractVersion:1,contextDigest:c.contextDigest,selections:days.map((day,i)=>({day,optionId:options[i].optionId,decision:{role:options[i].state==='REST'?'RECOVERY':'PRIMARY',reason:'Fixture: distribución para el trabajo pendiente.'}}))};}
