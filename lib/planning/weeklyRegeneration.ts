...
export type RegenerationPolicy = { pendingManagedDays: string[]; openCoachDecision?: true; explicitAvailabilityDecision?: true };
...
export function weeklyRegenerationOutcome(policy: RegenerationPolicy | undefined, slots: readonly Slot[]) {
  ...
  if (policy.openCoachDecision && policy.explicitAvailabilityDecision) return null;
