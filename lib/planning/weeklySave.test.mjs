...
async function backend(options = {}) {
  ...
  const execute = executable(actionBody, {
    ...
    assertWeeklyCalendar: async () => {}, admitSessionContent: session => session, assertFreshSessionRestrictions: async () => { if(options.freshnessError) throw new Error("SESSION_RESTRICTIONS_CHANGED_REGENERATE"); }, assertCurrentPrescriptionScope: async () => {},
