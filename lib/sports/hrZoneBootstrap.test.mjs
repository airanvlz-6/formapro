...
test('complete admitted zones precede easyHr; declared zones win over estimate; no generic Z2 alias',()=>{
  ...
  assert.equal(contract(p,{fc_suave:140,...declared}).intensityAuthority.targets[0].primary.referenceId,'running:confirmedBaseZone');
