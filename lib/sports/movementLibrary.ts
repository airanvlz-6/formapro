...
const MOVIMIENTOS_BOX: Record<string, Movimiento> = {
  ...
  legless_rope_climb: { id: "legless_rope_climb", discipline: "box", movement_pattern: "vertical_pull", stimulus: ["gimnasticos"], equipment: ["cuerda"], technical_demand: "alta", impact: "bajo", axial_load: "bajo", scalable: false, progressions: [], regressions: ["rope_climb"], suitable_for: ["gimnasticos"], avoid_with: ["hombro", "muñeca"], fatigue_cost: "alto", recovery_cost_horas: 24 },
  ...
  broad_jump: { id: "broad_jump", discipline: "box", movement_pattern: "jump", stimulus: ["potencia"], equipment: [], technical_demand: "baja", impact: "alto", axial_load: "bajo", scalable: true, suitable_for: ["potencia"], avoid_with: ["rodilla", "tobillo"], fatigue_cost: "medio", recovery_cost_horas: 12 },
