...
export interface Movimiento {
  ...
  stimulus: string[];
  equipment: string[];
  /** Each inner group is ANY; all groups are required. Default equipment list is ALL. */
  ...
  /** Explicit timed hold semantics for dose validation; absent means no timed-hold authority. */
  dose_basis?: "duration";
}
...
const MOVIMIENTOS_BOX: Record<string, Movimiento> = {
  // --- SQUAT ---
  back_squat: { id: "back_squat", discipline: ["box"], movement_pattern: "squat", stimulus: ["fuerza_maxima", "hipertrofia"], equipment: ["barra", "rack"], technical_demand: "alta", impact: "bajo", axial_load: "alto", scalable: true, progressions: ["back_squat_pausa"], regressions: ["goblet_squat"], variants: ["front_squat", "box_squat", "overhead_squat"], suitable_for: ["fuerza_maxima", "hipertrofia"], avoid_with: ["rodilla", "lumbar"], fatigue_cost: "alto", recovery_cost_horas: 48 },
  front_squat: { id: "front_squat", discipline: ["box"], movement_pattern: "squat", stimulus: ["fuerza_maxima", "halterofilia_soporte"], equipment: ["barra", "rack"], technical_demand: "alta", impact: "bajo", axial_load: "alto", scalable: true, variants: ["back_squat"], suitable_for: ["fuerza_maxima", "halterofilia_soporte"], avoid_with: ["rodilla", "muñeca"], fatigue_cost: "alto", recovery_cost_horas: 48 },
  ...
  box_squat: { id: "box_squat", discipline: ["box"], movement_pattern: "squat", stimulus: ["fuerza_maxima"], equipment: ["barra", "cajon", "rack"], technical_demand: "media", impact: "bajo", axial_load: "alto", scalable: true, suitable_for: ["fuerza_maxima"], avoid_with: ["rodilla", "lumbar"], fatigue_cost: "alto", recovery_cost_horas: 48 },
  goblet_squat: { id: "goblet_squat", discipline: ["box", "carrera"], movement_pattern: "squat", stimulus: ["fuerza_general", "tecnica", "fuerza_corredor"], equipment: ["mancuerna", "kettlebell"], equipmentRequirements: [["mancuerna", "kettlebell"]], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["front_squat"], suitable_for: ["fuerza_general", "tecnica", "fuerza_corredor"], fatigue_cost: "bajo", recovery_cost_horas: 24 },
  ...
  rdl: { id: "rdl", discipline: ["box", "carrera"], movement_pattern: "hinge", stimulus: ["cadena_posterior", "fuerza_general", "fuerza_corredor"], equipment: ["barra", "mancuerna"], equipmentRequirements: [["barra", "mancuerna"]], technical_demand: "media", impact: "bajo", axial_load: "medio", scalable: true, variants: ["deadlift", "single_leg_rdl"], suitable_for: ["cadena_posterior", "fuerza_corredor"], avoid_with: ["lumbar"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  ...
  // --- HORIZONTAL PUSH ---
  bench_press: { id: "bench_press", discipline: ["box"], movement_pattern: "horizontal_push", stimulus: ["fuerza_maxima", "hipertrofia"], equipment: ["barra", "banco", "rack"], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, variants: ["db_bench_press", "close_grip_bench"], suitable_for: ["fuerza_maxima", "hipertrofia"], avoid_with: ["hombro"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  ...
  muscle_up: { id: "muscle_up", discipline: ["box"], movement_pattern: "vertical_pull", stimulus: ["gimnasticos"], equipment: ["barra_dominadas", "anillas"], equipmentRequirements: [["barra_dominadas", "anillas"]], technical_demand: "alta", impact: "bajo", axial_load: "bajo", scalable: false, regressions: ["pull_up", "dip"], suitable_for: ["gimnasticos"], avoid_with: ["hombro"], fatigue_cost: "alto", recovery_cost_horas: 24 },
  ...
  farmers_carry: { id: "farmers_carry", discipline: ["box"], movement_pattern: "carry", stimulus: ["fuerza_general", "capacidad_aerobica"], equipment: ["mancuerna", "kettlebell"], equipmentRequirements: [["mancuerna", "kettlebell"]], technical_demand: "baja", impact: "bajo", axial_load: "medio", scalable: true, suitable_for: ["fuerza_general"], avoid_with: ["lumbar"], fatigue_cost: "medio", recovery_cost_horas: 12 },
  ...
  hollow_hold: { id: "hollow_hold", dose_basis: "duration", discipline: ["box"], movement_pattern: "core_flexion", stimulus: ["gimnasticos", "fuerza_general"], equipment: [], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, suitable_for: ["gimnasticos", "fuerza_general"], fatigue_cost: "bajo", recovery_cost_horas: 8 },
  ...
  plank: { id: "plank", dose_basis: "duration", discipline: ["box"], movement_pattern: "core_antiextension", stimulus: ["fuerza_general", "tecnica"], equipment: [], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, suitable_for: ["fuerza_general", "tecnica"], fatigue_cost: "bajo", recovery_cost_horas: 6 },
  ...
  handstand_hold: { id: "handstand_hold", dose_basis: "duration", discipline: ["box"], movement_pattern: "vertical_push", stimulus: ["gimnasticos"], equipment: [], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["freestanding_handstand"], suitable_for: ["gimnasticos"], avoid_with: ["hombro", "muñeca"], fatigue_cost: "bajo", recovery_cost_horas: 8 },
  ...
  overhead_carry: { id: "overhead_carry", discipline: ["box"], movement_pattern: "carry", stimulus: ["fuerza_general"], equipment: ["mancuerna", "kettlebell"], equipmentRequirements: [["mancuerna", "kettlebell"]], technical_demand: "media", impact: "bajo", axial_load: "medio", scalable: true, suitable_for: ["fuerza_general"], avoid_with: ["hombro", "lumbar"], fatigue_cost: "medio", recovery_cost_horas: 12 },
  ...
  close_grip_bench: { id: "close_grip_bench", discipline: ["box"], movement_pattern: "horizontal_push", stimulus: ["hipertrofia", "fuerza_general"], equipment: ["barra", "banco", "rack"], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, variants: ["bench_press"], suitable_for: ["hipertrofia", "fuerza_general"], avoid_with: ["hombro", "muñeca"], fatigue_cost: "medio", recovery_cost_horas: 24 },
};
