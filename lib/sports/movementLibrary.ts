...
export type PatronMovimiento =
  | "squat" | "hinge" | "horizontal_push" | "vertical_push" | "pull"
  | "olympic_lift" | "carry" | "run" | "jump" | "core_antirotacion" | "core_flexion"
  | "core_antiextension" | "locomotion" | "lunge" | "rotational";
...
const MOVIMIENTOS_BOX: Record<string, Movimiento> = {
  ...
  goblet_squat: { id: "goblet_squat", discipline: "box", movement_pattern: "squat", stimulus: ["fuerza_general", "tecnica"], equipment: ["mancuerna", "kettlebell"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["front_squat"], suitable_for: ["fuerza_general", "tecnica"], fatigue_cost: "bajo", recovery_cost_horas: 24 },
  ...
  rdl: { id: "rdl", discipline: "box", movement_pattern: "hinge", stimulus: ["cadena_posterior", "fuerza_general"], equipment: ["barra", "mancuerna"], technical_demand: "media", impact: "bajo", axial_load: "medio", scalable: true, variants: ["deadlift"], suitable_for: ["cadena_posterior"], avoid_with: ["lumbar"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  ...
  // --- PULL ---
  pull_up: { id: "pull_up", discipline: "box", movement_pattern: "pull", stimulus: ["gimnasticos", "fuerza_general"], equipment: ["barra_dominadas"], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["muscle_up"], regressions: ["ring_row"], variants: ["kipping_pull_up", "chest_to_bar", "strict_pull_up"], suitable_for: ["gimnasticos", "fuerza_general"], avoid_with: ["hombro"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  chest_to_bar: { id: "chest_to_bar", discipline: "box", movement_pattern: "pull", stimulus: ["gimnasticos"], equipment: ["barra_dominadas"], technical_demand: "alta", impact: "bajo", axial_load: "bajo", scalable: false, regressions: ["pull_up"], suitable_for: ["gimnasticos"], avoid_with: ["hombro"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  muscle_up: { id: "muscle_up", discipline: "box", movement_pattern: "pull", stimulus: ["gimnasticos"], equipment: ["barra_dominadas", "anillas"], technical_demand: "alta", impact: "bajo", axial_load: "bajo", scalable: false, regressions: ["pull_up", "dip"], suitable_for: ["gimnasticos"], avoid_with: ["hombro"], fatigue_cost: "alto", recovery_cost_horas: 24 },
  ring_row: { id: "ring_row", discipline: "box", movement_pattern: "pull", stimulus: ["fuerza_general", "tecnica"], equipment: ["anillas"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["pull_up"], suitable_for: ["fuerza_general", "tecnica"], fatigue_cost: "bajo", recovery_cost_horas: 12 },
  barbell_row: { id: "barbell_row", discipline: "box", movement_pattern: "pull", stimulus: ["hipertrofia", "fuerza_general"], equipment: ["barra"], technical_demand: "media", impact: "bajo", axial_load: "medio", scalable: true, suitable_for: ["hipertrofia", "fuerza_general"], avoid_with: ["lumbar"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  ...
  row_erg: { id: "row_erg", discipline: "box", movement_pattern: "carry", stimulus: ["capacidad_aerobica", "capacidad_glucolitica"], equipment: ["remo"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, suitable_for: ["capacidad_aerobica", "capacidad_glucolitica"], fatigue_cost: "medio", recovery_cost_horas: 12 },
  bike_erg: { id: "bike_erg", discipline: "box", movement_pattern: "carry", stimulus: ["capacidad_aerobica", "capacidad_glucolitica"], equipment: ["bici_estatica"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, suitable_for: ["capacidad_aerobica", "capacidad_glucolitica"], fatigue_cost: "bajo", recovery_cost_horas: 8 },
  ski_erg: { id: "ski_erg", discipline: "box", movement_pattern: "carry", stimulus: ["capacidad_aerobica", "capacidad_glucolitica"], equipment: ["ski_erg"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, suitable_for: ["capacidad_aerobica", "capacidad_glucolitica"], fatigue_cost: "medio", recovery_cost_horas: 12 },
  ...
  // --- LUNGE ---
  walking_lunge: { id: "walking_lunge", discipline: "box", movement_pattern: "lunge", stimulus: ["fuerza_general", "capacidad_aerobica"], equipment: [], technical_demand: "baja", impact: "medio", axial_load: "bajo", scalable: true, variants: ["overhead_lunge", "db_lunge"], suitable_for: ["fuerza_general"], avoid_with: ["rodilla"], fatigue_cost: "medio", recovery_cost_horas: 12 },
  bulgarian_split_squat: { id: "bulgarian_split_squat", discipline: "box", movement_pattern: "lunge", stimulus: ["fuerza_general", "hipertrofia"], equipment: ["banco"], technical_demand: "media", impact: "bajo", axial_load: "medio", scalable: true, suitable_for: ["fuerza_general", "hipertrofia"], avoid_with: ["rodilla"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  ...
  handstand_walk: { id: "handstand_walk", discipline: "box", movement_pattern: "carry", stimulus: ["gimnasticos", "coordinacion"], equipment: [], technical_demand: "alta", impact: "bajo", axial_load: "bajo", scalable: false, suitable_for: ["gimnasticos", "coordinacion"], avoid_with: ["hombro", "muñeca"], fatigue_cost: "medio", recovery_cost_horas: 24 },
  strict_pull_up: { id: "strict_pull_up", discipline: "box", movement_pattern: "pull", stimulus: ["gimnasticos", "fuerza_general"], equipment: ["barra_dominadas"], technical_demand: "media", impact: "bajo", axial_load: "bajo", scalable: true, progressions: ["chest_to_bar"], regressions: ["ring_row"], suitable_for: ["gimnasticos", "fuerza_general"], avoid_with: ["hombro"], fatigue_cost: "medio", recovery_cost_horas: 24 },

  // --- MONOSTRUCTURAL adicional ---
  assault_bike: { id: "assault_bike", discipline: "box", movement_pattern: "carry", stimulus: ["capacidad_glucolitica", "capacidad_aerobica"], equipment: ["assault_bike"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, variants: ["bike_erg"], suitable_for: ["capacidad_glucolitica", "capacidad_aerobica"], fatigue_cost: "alto", recovery_cost_horas: 12 },
  echo_bike: { id: "echo_bike", discipline: "box", movement_pattern: "carry", stimulus: ["capacidad_glucolitica", "capacidad_aerobica"], equipment: ["echo_bike"], technical_demand: "baja", impact: "bajo", axial_load: "bajo", scalable: true, variants: ["assault_bike"], suitable_for: ["capacidad_glucolitica", "capacidad_aerobica"], fatigue_cost: "alto", recovery_cost_horas: 12 },
...
export function getMovimientosPorEstimulo(estimuloId: string, disciplina: string): Movimiento[] {
  return Object.values(MOVEMENT_LIBRARY).filter(
    m => m.discipline === disciplina && m.suitable_for.includes(estimuloId)
  );
}
