...
test('adapter independently enforces supplied structured intent without inferring it from focus', async () => {
  ...
  assert.deepEqual(plain(result), { ok: false, errors: ['INTENT_POOL_EMPTY'] });
});
