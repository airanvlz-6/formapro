...
Variantes v1 usan RPE/RIR y dosis compatibles; NO %1RM ni referencias HR/pace heredadas. No inventes kg. Ausencia factual de recursos, restricciones, scope, referencias, estructura ejecutable y tiempo siguen siendo hard; UNKNOWN de recursos no bloquea coach-executable-v1.
...
En coach-executable-v1, UNKNOWN de equipo, skill o capability es una falta de conocimiento, no una prohibición: decide con el contexto disponible sin inventar AVAILABLE. Ausencia explícita, restricciones relevantes y referencias objetivas necesarias siguen siendo hard. Los contratos históricos conservan su suficiencia estricta. Restricciones activas se comprueban sobre la semántica de cada movimiento. Referencias deben ser exactas compatibles. Propón cantidad, estructura, RPE/RIR o referencia válida y descanso; respeta tiempo, cardinalidad y work/rest.
